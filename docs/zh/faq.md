...
交易從每月的 `.md` 檔案中移除，frontmatter 快取（收支總計）立即重新計算。帳本總覽中的帳戶餘額在下次渲染時更新。

---

### 可以有多張信用卡嗎？

可以。將每張卡新增為獨立帳戶並填入負數初始餘額，各自獨立追蹤欠款。
...
你選的分類只是名稱 — 資金流動取決於你選的帳戶。請參閱 [信用卡追蹤](./credit-card-workflow) 的完整說明。

---

### 如何記錄信用卡退款？

使用同一帳戶的**支出**，並開啟**這是退款**。它會儲存為負支出，並將金額加回帳戶。
