...
hero:
  ...
  tagline: Log expenses, income, transfers, and refunds as plain Markdown files in your vault.
  image:
...
features:
  - title: Plain Markdown Storage
    details: All data stored as .md files and a .json config — no proprietary database, no binary files. Fully portable and Git-friendly.
  - title: Three Transaction Types
    details: Expense, Income, and Transfer — with refunds stored as negative expenses.
